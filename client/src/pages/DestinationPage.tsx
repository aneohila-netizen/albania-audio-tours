...
import { ArrowLeft, MapPin, Star, Clock, ChevronRight, ChevronDown, Lightbulb, Navigation, LayoutGrid, List, Share2, Check, Copy } from "lucide-react";
    ...
    <div className="max-w-3xl mx-auto px-4 py-6 space-y-6">
      ...
      {(() => {
        ...
        const handleShare = async () => {
          // Native Web Share API — works on mobile (shows WhatsApp, iMessage, etc)
          if (typeof navigator !== "undefined" && (navigator as any).share) {
            try {
              await (navigator as any).share({ title: name, text: shareText, url: shareUrl });
              return;
        ...
        return (
          <div className="flex items-center gap-2">
            {/* Primary share button — native API on mobile, copy on desktop */}
            <button
              onClick={handleShare}
            ...
            >
              ...
              {shareCopied ? "Link copied!" : "Share this tour"}
            </button>
            {/* WhatsApp direct — always visible as explicit option */}
            <a
              href={whatsappUrl}
              target="_blank"
