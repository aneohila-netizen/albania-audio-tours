...
class PgStorage implements IStorage {
  ...
  private async _init(databaseUrl: string) {
    ...
    const newLangCols = [
      ...
      "ALTER TABLE tour_sites ADD COLUMN IF NOT EXISTS name_ru TEXT DEFAULT ''",
      ...
      "ALTER TABLE tour_sites ADD COLUMN IF NOT EXISTS desc_ru TEXT DEFAULT ''",
      ...
      "ALTER TABLE tour_sites ADD COLUMN IF NOT EXISTS fun_fact_ru TEXT",
      ...
      "ALTER TABLE tour_sites ADD COLUMN IF NOT EXISTS audio_url_ru TEXT",
      ...
      "ALTER TABLE attractions ADD COLUMN IF NOT EXISTS name_ru TEXT DEFAULT ''",
      ...
      "ALTER TABLE attractions ADD COLUMN IF NOT EXISTS desc_ru TEXT DEFAULT ''",
      ...
      "ALTER TABLE attractions ADD COLUMN IF NOT EXISTS fun_fact_ru TEXT DEFAULT ''",
      ...
      "ALTER TABLE attractions ADD COLUMN IF NOT EXISTS audio_url_ru TEXT",
  ...
  private rowToSite(r: any): TourSite {
    return {
      ...
      audioUrlFr: r.audio_url_fr||null, audioUrlAr: r.audio_url_ar||null, audioUrlRu: r.audio_url_ru||null, audioUrlPt: r.audio_url_pt||null, audioUrlCn: r.audio_url_cn||null,
  ...
  async updateSite(id: number, data: Partial<InsertTourSite>): Promise<TourSite | undefined> {
    ...
    const map: Record<string, string> = {
      ...
      nameIt: "name_it", nameEs: "name_es", nameDe: "name_de", nameFr: "name_fr", nameAr: "name_ar", nameRu: "name_ru", namePt: "name_pt", nameCn: "name_cn",
      descEn: "desc_en", descAl: "desc_al", descGr: "desc_gr",
      descIt: "desc_it", descEs: "desc_es", descDe: "desc_de", descFr: "desc_fr", descAr: "desc_ar", descRu: "desc_ru", descPt: "desc_pt", descCn: "desc_cn",
      ...
      funFactFr: "fun_fact_fr", funFactAr: "fun_fact_ar", funFactRu: "fun_fact_ru", funFactPt: "fun_fact_pt", funFactCn: "fun_fact_cn",
      ...
      audioUrlFr: "audio_url_fr", audioUrlAr: "audio_url_ar", audioUrlRu: "audio_url_ru", audioUrlPt: "audio_url_pt", audioUrlCn: "audio_url_cn",
